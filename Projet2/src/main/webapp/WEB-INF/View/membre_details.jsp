	...
	<body>
		...
		<main>
			<section class="content">
				...
				<div class="row">
					<div class="container">
						<h5>D&eacute;tails du membre n&ring; ${idDuMembre}</h5>
								...
								<div class="row">
									...
									<div class="input-field col s4">
										<select name="abonnement" class="browser-default">
											...
											<option value="BASIC" ${(aboDuMembre=="BASIC") ? "selected"
												:"" } >
												Abonnement BASIC</option>
											<option value="PREMIUM" ${(aboDuMembre=="PREMIUM") ? "selected"
												:"" }>Abonnement PREMIUM</option>
											<option value="VIP" ${(aboDuMembre=="VIP") ? "selected" : "" }>
								...
								<table class="striped">
									...
									<tbody id="results">
										<c:forEach var="emprunt" items="${empruntsEnCours}">
											<tr>
												<td>${emprunt.getLivre().getTitre()}
												</td>
												<td>${emprunt.getDateEmprunt()}</td>
												<td>
													<a href="emprunt_return?id=${emprunt.getId()}">retourner
													</a>
												</td>
											</tr>
										</c:forEach>
