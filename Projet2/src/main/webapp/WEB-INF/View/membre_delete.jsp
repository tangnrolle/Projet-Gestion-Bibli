  ...
  <body>
    ...
    <main>
      <section class="content">
        ...
        <div class="row">
          <div class="container">
            <h5>Suppression du membre n&ring; ${idDuMembre}</h5> <!-- TODO : remplacer 312 par l'id du membre -->
            <div class="row">
              <p>&ecirc;tes-vous s&ucirc;r de vouloir supprimer la fiche de ${prenomDuMembre} ${nomDuMembre} ?</p>
              ...
              <form action="/TP3Ensta/membre_delete" method="post" class="col s12">
                ...
                <div class="row center">
                  ...
                  <a class="btn waves-effect waves-light orange"
                    href="/TP3Ensta/membre_details?id=${idDuMembre}">Annuler</a>
                  <!-- TODO : remplacer idDuMembre par l'id du membre -->
                </div>
              </form>
            </div>
